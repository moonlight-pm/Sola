...
4. **Shell Bluetooth + volume** (on master) —
   ...
   **Not installed.**
   ...
   install `shell` so the volume chip returns (pw-cli graph; Steam wpctl stall).
