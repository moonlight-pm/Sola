...
14. **sola-arcade / windowed gamescope** — **partial, dogfoodable** (on master)  
   ...
   **Install:** standing OK to `install arcade` after each finished round.  
   ...
   - Backlog: Portal-class nest fails; residual flicker; title contrast;
     never-played owned without API; VDF/decode bounds; lock/unlock + custom
     cursor titles (The Séance of Blake Manor — nest `--cursor-scale-height`
     / do not global `--force-grab-cursor`; see
