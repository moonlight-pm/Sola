...
| Calendar | **This worktree.** App **installed** `calendar`+`shell` 2026-09-08. Settings accounts (Google / iCloud / CalDAV / URL, multiple) on `Topic::CalendarConfig` — needs `install bus settings calendar` (unsmoked). | — |
