...
6. **sola-mail** — **partial** (on **this worktree**; master still the 2026-08-26 install).
   ...
   **Install:** needs `mail` to dogfood this refresh fix.
...
| Mail | **This worktree:** other-client inbox MOVE/EXPUNGE no longer stick on the list (IDLE + 45s poll were already there; silent merge was keeping ghosts). Master install is still 2026-08-26. No HTML engine / attachments | — |
