...
3. **Browser** — codecs CEF (H.264/AAC `canPlayType` `probably`) +
   ...
   **Next:** desk-smoke vault item edit Save; Google passkey picker; Find + JS dialogs after
