...
| Terminal | **On this branch** (lib via Workspaces **installed** 2026-09-10): grid selection is neon accent wash (`#3dd6f5` @ 55%). Wash follows `display_offset` scrollback and TUI CUP-rewrites (`sel_follow` during drag and page-sized Grok/Codex wheels). sola-terminal binary last installed 2026-09-02 | — |
