...
impl Palette {
    ...
    pub fn seed() -> Self {
        ...
        palette.tokens.insert(
            "bg-primary".into(),
            Token::new(TokenKind::Color, "#0c0e12", &["surface"]),
        );
        palette.tokens.insert(
            "bg-secondary".into(),
            Token::new(TokenKind::Color, "#151922", &["surface"]),
        );
        palette.tokens.insert(
            "bg-tertiary".into(),
            Token::new(TokenKind::Color, "#1e2533", &["surface"]),
        );
        palette.tokens.insert(
            "bg-hover".into(),
            Token::new(TokenKind::Color, "#1e2533", &["surface"]),
        ...
        palette.tokens.insert(
            "border".into(),
            Token::new(TokenKind::Color, "#2a3344", &["border"]),
        );
        palette.tokens.insert(
            "border-subtle".into(),
            Token::new(TokenKind::Color, "#1e2533", &["border"]),
        );
        // Colors — text
        palette.tokens.insert(
            "text-primary".into(),
            Token::new(TokenKind::Color, "#e9ecf2", &["text"]),
        );
        palette.tokens.insert(
            "text-secondary".into(),
            Token::new(TokenKind::Color, "#8b94a8", &["text"]),
        );
        palette.tokens.insert(
            "text-tertiary".into(),
            Token::new(TokenKind::Color, "#6b7385", &["text"]),
        );
        ...
        palette.tokens.insert(
            "accent".into(),
            Token::new(TokenKind::Color, "#3dd6f5", &["accent"]),
        );
        palette.tokens.insert(
            "accent-dim".into(),
            Token::new(
        ...
        palette.tokens.insert(
            "danger".into(),
            Token::new(TokenKind::Color, "#f07178", &["status"]),
        );
        palette.tokens.insert(
            "success".into(),
            Token::new(TokenKind::Color, "#3ecf8e", &["status"]),
        );
        palette.tokens.insert(
            "warning".into(),
            Token::new(TokenKind::Color, "#e8b84a", &["status"]),
        );
        ...
        palette.tokens.insert(
            "text-caption".into(),
            Token::new(TokenKind::TextSize, "11px", &["text-size"]),
        );
        palette.tokens.insert(
            "text-body".into(),
            Token::new(TokenKind::TextSize, "12px", &["text-size"]),
        );
        palette.tokens.insert(
            "text-body-lg".into(),
        ...
        palette.tokens.insert(
            "text-heading".into(),
            Token::new(TokenKind::TextSize, "16px", &["text-size"]),
        );
        palette.tokens.insert(
            "text-display".into(),
            Token::new(TokenKind::TextSize, "20px", &["text-size"]),
        );
        // Spacing
        palette.tokens.insert(
            "space-xs".into(),
            Token::new(TokenKind::Space, "4px", &["space"]),
        );
        palette.tokens.insert(
            "space-sm".into(),
            Token::new(TokenKind::Space, "8px", &["space"]),
        );
        palette.tokens.insert(
            "space-md".into(),
            Token::new(TokenKind::Space, "12px", &["space"]),
        );
        palette.tokens.insert(
            "space-lg".into(),
            Token::new(TokenKind::Space, "16px", &["space"]),
        );
        palette.tokens.insert(
            "space-xl".into(),
            Token::new(TokenKind::Space, "20px", &["space"]),
        );
        palette.tokens.insert(
            "space-xxl".into(),
            Token::new(TokenKind::Space, "24px", &["space"]),
        );
        // Radius — kit control scale (sola-kit-ds)
        palette.tokens.insert(
            "radius-sm".into(),
            Token::new(TokenKind::Radius, "5px", &["radius"]),
        );
        palette.tokens.insert(
            "radius-md".into(),
            Token::new(TokenKind::Radius, "7px", &["radius"]),
        );
        palette.tokens.insert(
            "radius-lg".into(),
            Token::new(TokenKind::Radius, "10px", &["radius"]),
        );
        ...
        palette.tokens.insert(
            "shell-menubar-bg".into(),
            Token::new(TokenKind::Color, "#050608", &["shell"]),
        );
        palette.tokens.insert(
        ...
        palette.tokens.insert(
            "shell-switcher-pad".into(),
            Token::new(TokenKind::Space, "14px", &["shell"]),
        );
        palette.tokens.insert(
