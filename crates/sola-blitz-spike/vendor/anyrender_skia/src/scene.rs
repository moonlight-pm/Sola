...
pub struct SkiaSceneCache {
    ...
    pub(crate) swash: crate::swash_glyphs::SwashGlyphs,
}
...
impl Default for SkiaSceneCache {
    fn default() -> Self {
        Self {
            ...
            swash: crate::swash_glyphs::SwashGlyphs::new(),
        }
    }
}
...
impl PaintScene for SkiaScenePainter<'_> {
    ...
    fn draw_glyphs<'a, 's: 'a>(
        ...
        let rgba = crate::swash_glyphs::solid_rgba(&brush, brush_alpha);
        if self.draw_glyphs_swash(
            font,
            font_size,
            hint,
            rgba,
