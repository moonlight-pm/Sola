...
// and labelless variants. Uses TextInput as the contained control
// to also exercise the Field+TextInput pairing that's the standard
// form row in the kit.
...
export function FieldShowcase(_handle: Handle) {
  return () => (
    <Stack gap="var(--space-xxl)">
      ...
      <BindingsEditor componentName="field" />
    </Stack>
  );
}
