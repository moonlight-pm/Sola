...
//!
//! Mirrors `crates/sola-monitor/build.rs`. Every iced binary in the
//! workspace-exclude list needs this; consolidating into a helper
//! crate isn't worth it (build.rs can't easily share code).
//!
