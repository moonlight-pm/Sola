...
pub use sidebar::{
    ...
    ReorderCfg, SIDEBAR_WIDTH, SidebarItem, SidebarPanel, SidebarSection, TabDescriptor, TabSize,
    panel_dragged_width, panel_drop_index, panel_drop_index_relative, panel_renumber_changed,
    panel_reordered, panel_sibling_offset, sidebar, vertical_tabs, vertical_tabs_sized,
};
