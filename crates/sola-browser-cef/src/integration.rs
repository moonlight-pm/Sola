//! Sola-bus integration for the CEF browser.
//!
//! Mirror of `sola-browser-wpe`'s integration module. The connect + subscribe +
//! app-menu publish happens once in `main` via `sola_kit::app::BusSetup`; this
//! module is the receive side. It reacts to:
//!
...
pub fn url_input_id() -> iced::advanced::widget::Id {
    iced::advanced::widget::Id::new("cef-url-bar")
}
