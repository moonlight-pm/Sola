//! DMA-BUF → `wgpu::Texture` import for frames coming out of CEF.
//!
...
//! `0x300000000606014` in the CEF case) is non-LINEAR — but the
//! reported stride matches what LINEAR would have, and ad-hoc
//! mmap+read produced correct pixels in `cef-probe`, so we try
...
pub unsafe fn import(
    ...
    // sRGB-encoded color. CEF's WebProcess renders sRGB pixels and
