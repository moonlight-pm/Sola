...
impl ChildSwap {
    pub fn new(display: *mut std::ffi::c_void, surface: *mut std::ffi::c_void) -> Option<Self> {
        ...
        let raw_display = winit::raw_window_handle::RawDisplayHandle::Wayland(
            winit::raw_window_handle::WaylandDisplayHandle::new(display),
        );
        let raw_window = winit::raw_window_handle::RawWindowHandle::Wayland(
            winit::raw_window_handle::WaylandWindowHandle::new(surface_ptr),
        );
        let instance = wgpu::Instance::new(&wgpu::InstanceDescriptor {
            backends: wgpu::Backends::VULKAN | wgpu::Backends::GL,
            ..Default::default()
