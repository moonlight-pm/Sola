...
| [`manual/`](manual/) | Operator truth (fonts, kvm, **shell**, **arcade**, **browser**, **paint**, **monitor**, **wrapper**, **scope**, **spotify**, **solactl**, dist notes; ISO guide when dogfoodable) | **Product** (shipped only) |
