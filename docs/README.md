...
| [`manual/`](manual/) | Operator truth (fonts, kvm, **shell**, **arcade**, **browser**, **paint**, **preview**, **monitor**, **wrapper**, **scope**, **spotify**, **mail**, **solactl**, dist notes; ISO guide when dogfoodable) | **Product** (shipped only) |
