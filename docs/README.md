...
| [`manual/`](manual/) | Operator truth (fonts, kvm, **shell**, **arcade**, **browser**, **paint**, **preview**, **monitor**, **wrapper**, **scope**, **solactl**, dist notes; ISO guide when dogfoodable) | **Product** (shipped only) |
