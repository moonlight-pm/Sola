...
Clipboard history, paint paste/copy, kvm Mac image sync, primary selection, toast-click-to-open Preview.
...
| Home | `sola_kit::clipboard` (kit apps). kvm CLIP1 carries text + `image/png` Linux↔Linux. |
