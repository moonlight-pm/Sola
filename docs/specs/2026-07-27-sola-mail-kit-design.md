...
**Status:** implemented (partial) — dogfood installed locally 2026-08-21; optimistic delete + keyed list on master (`install mail` 2026-08-26); other-client inbox expunge **installed** this worktree (`mail` debug, 2026-08-28)  
