...
| ID | Capability | Status | Spec / plan | Dogfood | Gaps | Manual |
|----|------------|--------|-------------|---------|------|--------|
| shell-menubar | Top menubar, menus, clock/stats | shipped | [shell iced](specs/2026-05-22-sola-shell-iced-port-design.md) | local | Mail unread chip (accent; `Topic::MailStatus`; hidden when mail is not mapped). Visual polish vs macOS roadmap | no |
