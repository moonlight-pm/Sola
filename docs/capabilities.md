...
| Area | Notes |
|------|--------|
| **browser polish** | 2026-08-15: tab groups **installed** on `naturalethic/browser-polish` (smoke pending). Landed on master — downloads, cards, passkey get/create, chrome singleton, no phantom `↓ N` chip. Earlier: tab reorder + width-aware titles |
