...
| Area | Notes |
|------|--------|
| **browser polish** | 2026-08-15: tab groups **implemented** on `naturalethic/browser-polish` (not dogfooded). Landed on master — downloads, cards, passkey get/create, chrome singleton, no phantom `↓ N` chip. Earlier: tab reorder + width-aware titles |
