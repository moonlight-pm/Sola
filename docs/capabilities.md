...
| Area | Notes |
|------|--------|
| **browser polish** | 2026-08-15: tab groups **frozen** (not implemented) — folders at top, loose run at bottom, kit context menu. Landed on master — downloads, cards, passkey get/create, chrome singleton, no phantom `↓ N` chip. Earlier: tab reorder + width-aware titles |
