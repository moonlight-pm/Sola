...
| Area | Notes |
|------|--------|
| **browser polish** | 2026-08-15: chrome singleton (`chrome.sock`) + orphan-only helper reap + helper respawn; passkey **create**; Gemini Exchange passkey **get**; downloads flatten. 2026-08-14: downloads auto-save + toolbar list. Earlier: tab reorder + width-aware titles; Bitwarden **cards** |
