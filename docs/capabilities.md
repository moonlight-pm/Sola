...
| browser | Browser chrome + WPE engine (single crate) | partial | [hardening](plans/2026-08-09-sola-browser-hardening.md); [Bitwarden D7](specs/2026-08-10-sola-browser-bitwarden-design.md); [profiles D8](specs/2026-08-10-sola-browser-profiles-design.md); [content plane](specs/2026-08-11-sola-browser-content-plane-design.md); [paint investigation](plans/2026-08-10-browser-paint-investigation.md); [present deep-dive](plans/2026-08-11-browser-present-architecture-deep-dive.md); [checkerboard deep fix](plans/2026-08-11-browser-checkerboard-deep-fix.md) | local; YT + **`sola:scroll-stress`**; NVIDIA | **Shipped subset:** multi-tab chrome, omnibox+Kagi, bus menus, float CSD, content-plane paint (buffer cache, deferred front release, FrameDone on frame cb), **adaptive paint budget** (honest DPR + scroll ≤1.25×), **`SOLA_BROWSER_CONTENT=wayland`** stock WPEDisplayWayland (dual-window dogfood), **`sola:scroll-stress`** built-in, D8, Bitwarden, stop/history, copy/paste. **Gaps:** daily-driver hard-scroll bar (dogfood after budget); soft text if no SUPER_SAMPLE; Wayland mode needs river lockstep for single-window UX; no profile switcher; cookie stickiness; vault session; downloads/history UI; NV12; B1/B4/B5; D3; no operator manual. CEF gone | no |
...
| Area | Notes |
|------|--------|
| **sola-browser** | 2026-08-11: adaptive paint budget + scroll-stress page + optional stock WPE Wayland; checkerboard deep fix; D8; Bitwarden |
