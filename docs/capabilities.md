...
| browser | Browser chrome + WPE engine (single crate) | partial | browser freezes | local | Chrome features incomplete vs plan; engine quirks. CEF + core split removed (tag `pre-cef-removal`) | no |
