...
| Area | Notes |
|------|--------|
| **sola-browser** | 2026-08-11: content plane default; frame-paced present (no force-release); re-dogfood YT black/flicker; soft text open; D8; Bitwarden |
