...
**As of:** 2026-08-15 (workspaces + browser polish + paint on master)
...
| **browser polish** | 2026-08-15: landed on master — downloads, cards, passkey get/create, chrome singleton, no phantom `↓ N` chip. 2026-08-14: downloads auto-save + toolbar list. Earlier: tab reorder + width-aware titles |
