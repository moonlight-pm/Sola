...
| **browser polish** | 2026-08-17: **⌘-click** dogfooded (IMDb; chrome tab below current / same group); Super+drag removed; vault **authenticator** (site-matched TOTP, click-to-copy). 2026-08-15: tab groups + page chrome. Earlier: downloads, cards, passkey get/create |
