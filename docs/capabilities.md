...
| browser | Browser chrome + WPE engine (single crate) | partial | [hardening](plans/2026-08-09-sola-browser-hardening.md); [Bitwarden D7](specs/2026-08-10-sola-browser-bitwarden-design.md); [profiles D8](specs/2026-08-10-sola-browser-profiles-design.md); [content plane](specs/2026-08-11-sola-browser-content-plane-design.md); [paint investigation](plans/2026-08-10-browser-paint-investigation.md); [present deep-dive](plans/2026-08-11-browser-present-architecture-deep-dive.md) | local; YT homepage paints + scrolls; **NVIDIA** | **Shipped subset:** multi-tab chrome, omnibox+Kagi, bus menus, float CSD, **content-plane paint** (default `plane`: subsurface; **wl_buffer cache per WPEBuffer like stock WPEViewWayland**; no destroy on Release; FrameDone on frame cb; fence wait; multi-plane FDs; 2× DPR; empty input region), D8, Bitwarden, stop/history, copy/paste. **Paint:** SEGV/EMFILE fixed; G1–G4; architecture realigned toward stock present. **Gaps:** **daily-driver YT hard-scroll** (re-dogfood after cache); residual soft text; if still bad → WPEDisplayWayland or owned-linear; no profile switcher; cookie stickiness; vault session; downloads/history UI; NV12; B1/B4/B5; D3 Helium; no operator manual. CEF gone | no |
...
| Area | Notes |
|------|--------|
| **sola-browser** | 2026-08-11: stock-aligned plane present (wl_buffer cache, no destroy-on-Release); NVIDIA deep-dive; re-dogfood black/flicker; D8; Bitwarden |
