...
| Area | Notes |
|------|--------|
| **browser polish** | 2026-08-15: tab groups + page chrome (⌘V once, ⌘-click new tab, kit page context menu, hold back/forward history) on `naturalethic/browser-polish` (**installed**; smoke pending). Landed on master — downloads, cards, passkey get/create, chrome singleton, no phantom `↓ N` chip. Earlier: tab reorder + width-aware titles |
