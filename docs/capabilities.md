...
**As of:** 2026-08-18 (mail polish: letter pane drag-select + copy)
...
| Area | Notes |
|------|--------|
| **workspaces** | 2026-08-15: landed on master. 2026-08-14: renamed from sola-agent-terminal; owner `ws` (`solactl ws`); config `~/.config/sola/workspaces/` |
